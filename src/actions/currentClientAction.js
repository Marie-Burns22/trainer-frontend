...
export const login = (credentials, history) => {
    ...
    return dispatch => {
        return fetch("https://vimp.herokuapp.com/api/v1/login", {
            credentials: "include",    
            method: 'POST',
            headers: {
...
export const logout = (history) => {
    ...
    return dispatch => {
        ...
        history.push('/')
        return fetch('https://vimp.herokuapp.com/api/v1/logout', {
            credentials: "include",
            method: "DELETE"
        })
...
export const getCurrentClient = () => {
    return dispatch => {
        return fetch("https://vimp.herokuapp.com/api/v1/get_current_client", {
            credentials: "include",
            method: 'GET',
            headers: {
                "Content-Type": "application/json",
